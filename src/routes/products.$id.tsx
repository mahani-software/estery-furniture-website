    ...
    <SiteShell>
      <section className="container-x py-10">
        ...
        <div className="grid gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="mt-4 text-2xl text-primary">{formatUGX(p.price)}</div>
            <p className="mt-6 text-muted-foreground">{p.desc}</p>

            <div className="mt-8 grid grid-cols-2 gap-4 rounded-xl border border-border bg-card p-5 text-sm">
      ...
      {related.length > 0 && (
        <section className="container-x pb-24">
          <h2 className="mb-8 text-2xl">You may also like</h2>
